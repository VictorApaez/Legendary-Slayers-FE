      ...
      <div className="character-page-wrapper">
        ...
        <div className="filter-container">
          ...
          <form className="champClassFilter">
            <button id="all" data-value="" onClick={handleClassSearch}>
              All
            </button>
            <button
              id="assassin"
            ...
            <button id="mage" data-value="mage" onClick={handleClassSearch}>
              Mages
            </button>
            <button
              id="marksman"
            ...
            <button id="tank" data-value="tank" onClick={handleClassSearch}>
              Tanks
            </button>
          </form>
